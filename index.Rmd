...
I am infinitely curious and highly resourceful. I love playing piano, board games, modeling, reading sci fi, and programming. One theme through all these years is modeling--whether it be simulating nuclear magnetic resonance, playing an abstract simulation game or building a scale car and painting it.
...
If one needs predictive or explanatory statistical data science models^[Oddly now called AI by many folks] of data; this I can deliver. Understanding applied economic decision making with dimensions of cost and effectiveness is a specialty. 

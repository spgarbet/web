...
Eris (the Greek god of chaos) is a VCO with chaotic modulated output. It also features pulse width modulation of all output voices for enhanced timbre choices. The saw wave is modified using a beta function map to approximate the area under the curve to a square PWM wave.
